...
# The next lines are to generate the dat file for several error rates of the 2-q gate (CZ)
...
for t in list_ts:
    ...
    ps_ST3a = [p_prepST, p_measST, p_1qST, 0.1*p_CZST]
    ps_ST4a = [p_prepST, p_measST, p_1qST, 10*p_CZST]
    ps_ST0a = [p_prepST, p_measST, p_1qST, 0.*p_CZST]
...
data_filename = summary_folder + 'resultsQECd3_Imeas' + str(int(ratio_meas_times)) + 'p2q_Tplus.dat'
