...
# The next lines are to generate the dat file for several error rates of the prep gate
...
for t in list_ts:
    ...
    ps_ST2a = [p_prepST, p_measST, p_1qST, p_CZST]
    ps_ST3a = [0.1*p_prepST, p_measST, p_1qST, p_CZST]
    ps_ST4a = [10*p_prepST, p_measST, p_1qST, p_CZST]
    ps_ST0a = [0.*p_prepST, p_measST, p_1qST, p_CZST]
    ps_STb = [p_IprepST, p_Igate_LDST_data, p_Igate_LDST_anc, p_ImeasST]
    
    ps_ST2 = ps_ST2a + ps_STb
    ps_ST3 = ps_ST3a + ps_STb
    ps_ST4 = ps_ST4a + ps_STb
    ps_ST0 = ps_ST0a + ps_STb
...
data_filename = summary_folder + 'resultsQECd3_Imeas' + str(int(ratio_meas_times)) + 'pprep_Tplus.dat'
