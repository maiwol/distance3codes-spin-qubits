...
# The next lines are to generate the dat file for several error rates of the 1-q gate
...
for t in list_ts:
    ...
    ps_ST3a = [p_prepST, p_measST, 0.1*p_1qST, p_CZST]
    ps_ST4a = [p_prepST, p_measST, 10*p_1qST, p_CZST]
    ps_ST0a = [p_prepST, p_measST, 0.*p_1qST, p_CZST]
...
data_filename = summary_folder + 'resultsQECd3_Imeas' + str(int(ratio_meas_times)) + 'p1q_Tplus.dat'
